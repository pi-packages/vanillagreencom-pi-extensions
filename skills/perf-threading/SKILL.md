---
name: perf-threading
description: "Thread pinning, core isolation, SPSC channels, page fault prevention for Rust low-latency. Load when: pinning threads, choosing SPSC channels, configuring isolcpus/IRQ affinity, eliminating page fault jitter, benchmarking inter-thread latency."
license: MIT
user-invocable: true
metadata:
  author: vanillagreen
