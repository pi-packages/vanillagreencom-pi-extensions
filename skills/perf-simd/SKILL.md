---
name: perf-simd
description: "SIMD vectorization for Rust hot paths. Load when writing/reviewing numeric loops, intrinsics, auto-vectorization, AVX2/AVX-512 dispatch, std::simd, or CPU feature detection."
license: MIT
user-invocable: true
metadata:
  author: vanillagreen
...
SIMD intrinsics, auto-vectorization verification, and runtime dispatch for Rust hot paths.
