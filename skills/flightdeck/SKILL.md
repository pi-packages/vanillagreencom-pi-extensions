...
| `FLIGHTDECK_DASHBOARD_THEME` | `moon` | Color theme: `moon`, `dawn`, or `system`. CLI `--theme` overrides it; the theme picker popup changes the live theme for the current run. |
