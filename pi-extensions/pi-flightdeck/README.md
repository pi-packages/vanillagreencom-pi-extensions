...
- **`/flightdeck:dashboard` popup** (F6) — full mission-control view with six tabs:
...
| Command | Action |
|---|---|
| `/flightdeck` | Send `/skill:flightdeck` to the agent (loads the master skill) |
| `/flightdeck:dashboard` | Open the mission-control popup (also F6) |
